...
`;
    ...
    let main = () => {
        ...
        if (gameStage == "5") {
            addInfoFooter("Aufgabe: Bereich Meine Dateien > Persönliche Dateien > Ordner Nachricht entschlüsseln öffnen > Bild öffnen > Nachricht entschlüsseln!");
        ...
        if (gameStage == "13") {
            ...
            $('#entercontainer').append('<img id="theImg" style=\"z-index: 12\"src="' + hackerImageData + '" />')
            $('#entercontainer').append('<div id=\"enterthecloudfooter\" style=\"position: absolute;background: black;bottom: 0;left: 0;right: 0;box-shadow: 0px 3px 15px lightgrey, 0 0 11px lightgreen;width: 95%;max-width: 700px;margin: auto;color: green;padding: 10px;z-index: 13; min-height: 150px;\"><p>&gt;_ Hacker Message:</p><p id=\"hacker_textchat\"></p></div>');
            hackerWriting('Ok, ok, ok. Ihr habt mich erwischt.~ Ich bin eine Schülerin aus der Klasse unter dir … Ich wollte die Cloud hacken, um alle eure Hausaufgaben und Referate abzugreifen, damit ich nächstes Jahr weniger Arbeit habe … 💩');
        }
        if (gameStage == "14") {
            addOverlay();
            $('#entercontainer').append('<canvas id=\"myCanvasMatrix\" style=\" position: absolute; width: 100%; height: 100%;\"></canvas>');
            addCloudyDialog();
            addCloudyDialogText("Ciao Kakao, Ende Gelände, Tschüssikowsky, tüdelü! \nDer Hacker ist dank dir offiziell von der Cloud verbannt! 💥");
            ...
            $("input.btn.btn-primary").click(function () {
                ...
                addCloudyDialogPrimaryButton('Weiter!');
                $("input.btn.btn-primary").unbind("click").click(function () {
                    addCloudyDialogText("Falls ihr mal Probleme mit der HPI Schul-Cloud haben solltet, macht nicht eure Lehrer:in dafür verantwortlich. Wir haben einen Hilfebereich und freuen uns sehr, wenn ihr uns Feedback gebt!");
                    addCloudyDialogPrimaryButton('Weiter!');
                    $("input.btn.btn-primary").unbind("click").click(function () {
