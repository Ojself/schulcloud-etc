...
div#infofootercontainer {
    ...
    let main = () => {
        ...
        if (gameStage == "10") {
            ...
            $("input#checkButton").click(function () {
                if ($('input#inputPassword').val().toLowerCase().match(/^(handy|smartphone|dergerät|telefon)$/)) {
                    ...
                    addOverlay();
                    addCloudyDialog();
                    addCloudyDialogText("Yeah! Gut gemacht!\n \nGehe nun in den Bereich Kurse und besuche den Kurs ‘Wie man Hacker stoppt’.");
                    addCloudyDialogPrimaryButton('Ok!');
                    $("input.btn.btn-primary").click(function () {
                        removeOverlay();
                        nextGameStage(11);
        ...
        if (gameStage == "11") {
            addOverlay();
            addCloudyDialog();
            addCloudyDialogText("Gehe nun zu den Werkzeugen und öffne Geogebra.\nWenn du die Gleichung dort löst, können wir die geografische Position des Hackers bestimmen! 📍\n");
            addCloudyDialogPrimaryButton('Ok!');
            $("input.btn.btn-primary").click(function () {
                removeOverlay();
                nextGameStage(12);
